  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pcl_msgs__srv__UpdateFilename_Request;
    is_plain =
      (
...
static size_t _UpdateFilename_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pcl_msgs__srv__UpdateFilename_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pcl_msgs__srv__UpdateFilename_Response;
    is_plain =
      (
...
static size_t _UpdateFilename_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pcl_msgs__srv__UpdateFilename_Response(
    full_bounded, is_plain, 0);
