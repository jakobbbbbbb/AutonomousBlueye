...
#include "pcl_msgs/msg/detail/point_indices__rosidl_typesupport_fastrtps_c.h"
...
using _PointIndices__ros_msg_type = pcl_msgs__msg__PointIndices;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PointIndices__ros_msg_type * ros_message = static_cast<const _PointIndices__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PointIndices__ros_msg_type * ros_message = static_cast<_PointIndices__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _PointIndices__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pcl_msgs__msg__PointIndices(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pcl_msgs__msg__PointIndices;
    is_plain =
      (
...
static size_t _PointIndices__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pcl_msgs__msg__PointIndices(
...
static message_type_support_callbacks_t __callbacks_PointIndices = {
  "pcl_msgs::msg",
  "PointIndices",
...
static rosidl_message_type_support_t _PointIndices__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PointIndices,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pcl_msgs, msg, PointIndices)() {
  return &_PointIndices__type_support;
}
