...
#include "robot_interfaces/msg/detail/dvl__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::DVL & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.vel_body,
    cdr);
  // Member: uncertainty_vel
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.uncertainty_vel,
    cdr);
  // Member: vel_beam1
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::DVL & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::DVL;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::DVL *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::DVL *>(
    untyped_ros_message);
...
get_message_type_support_handle<robot_interfaces::msg::DVL>()
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, DVL)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
