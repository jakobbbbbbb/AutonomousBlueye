...
bool robot_interfaces__msg__desired_forces__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._desired_forces.DesiredForces", full_classname_dest, 50) == 0);
  }
  robot_interfaces__msg__DesiredForces * ros_message = _ros_message;
  {  // surge
...
{
  /* NOTE(esteve): Call constructor of DesiredForces */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._desired_forces");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DesiredForces");
