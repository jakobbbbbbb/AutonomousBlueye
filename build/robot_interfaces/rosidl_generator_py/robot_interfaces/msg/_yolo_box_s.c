...
bool robot_interfaces__msg__yolo_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._yolo_box.YoloBox", full_classname_dest, 38) == 0);
  }
  robot_interfaces__msg__YoloBox * ros_message = _ros_message;
  {  // cls
...
{
  /* NOTE(esteve): Call constructor of YoloBox */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_interfaces.msg._yolo_box");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "YoloBox");
