...
class Metaclass_AddWaypoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.srv.AddWaypoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interfaces.srv import _add_waypoint
...
class AddWaypoint(metaclass=Metaclass_AddWaypoint):
    from robot_interfaces.srv._add_waypoint import AddWaypoint_Request as Request
    from robot_interfaces.srv._add_waypoint import AddWaypoint_Response as Response
