...
#include "robot_interfaces/srv/detail/add_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _AddWaypoint_Request__ros_msg_type = robot_interfaces__srv__AddWaypoint_Request;
...
size_t get_serialized_size_robot_interfaces__srv__AddWaypoint_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddWaypoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__srv__AddWaypoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__srv__AddWaypoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces__srv__AddWaypoint_Request;
    is_plain =
      (
...
static size_t _AddWaypoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__srv__AddWaypoint_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, AddWaypoint_Request)() {
...
using _AddWaypoint_Response__ros_msg_type = robot_interfaces__srv__AddWaypoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t get_serialized_size_robot_interfaces__srv__AddWaypoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddWaypoint_Response__ros_msg_type * ros_message = static_cast<const _AddWaypoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__srv__AddWaypoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__srv__AddWaypoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robot_interfaces__srv__AddWaypoint_Response;
    is_plain =
      (
...
static size_t _AddWaypoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__srv__AddWaypoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, AddWaypoint_Response)() {
...
// already included above
// #include "robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robot_interfaces/srv/add_waypoint.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, srv, AddWaypoint)() {
