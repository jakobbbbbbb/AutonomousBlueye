...
#define NODE_MAIN_LOGGER_NAME "octomap_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboctomap_server2.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::OctomapServer>";
