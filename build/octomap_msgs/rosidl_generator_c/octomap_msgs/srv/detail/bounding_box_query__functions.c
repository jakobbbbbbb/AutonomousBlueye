...
octomap_msgs__srv__BoundingBoxQuery_Request__create()
{
  ...
  octomap_msgs__srv__BoundingBoxQuery_Request * msg = (octomap_msgs__srv__BoundingBoxQuery_Request *)allocator.allocate(sizeof(octomap_msgs__srv__BoundingBoxQuery_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
octomap_msgs__srv__BoundingBoxQuery_Request__Sequence__init(octomap_msgs__srv__BoundingBoxQuery_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (octomap_msgs__srv__BoundingBoxQuery_Request *)allocator.zero_allocate(size, sizeof(octomap_msgs__srv__BoundingBoxQuery_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  octomap_msgs__srv__BoundingBoxQuery_Request__Sequence * array = (octomap_msgs__srv__BoundingBoxQuery_Request__Sequence *)allocator.allocate(sizeof(octomap_msgs__srv__BoundingBoxQuery_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
octomap_msgs__srv__BoundingBoxQuery_Request__Sequence__are_equal(const octomap_msgs__srv__BoundingBoxQuery_Request__Sequence * lhs, const octomap_msgs__srv__BoundingBoxQuery_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!octomap_msgs__srv__BoundingBoxQuery_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  octomap_msgs__srv__BoundingBoxQuery_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(octomap_msgs__srv__BoundingBoxQuery_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    octomap_msgs__srv__BoundingBoxQuery_Request * data =
      (octomap_msgs__srv__BoundingBoxQuery_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!octomap_msgs__srv__BoundingBoxQuery_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          octomap_msgs__srv__BoundingBoxQuery_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!octomap_msgs__srv__BoundingBoxQuery_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  octomap_msgs__srv__BoundingBoxQuery_Response * msg = (octomap_msgs__srv__BoundingBoxQuery_Response *)allocator.allocate(sizeof(octomap_msgs__srv__BoundingBoxQuery_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
octomap_msgs__srv__BoundingBoxQuery_Response__Sequence__init(octomap_msgs__srv__BoundingBoxQuery_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (octomap_msgs__srv__BoundingBoxQuery_Response *)allocator.zero_allocate(size, sizeof(octomap_msgs__srv__BoundingBoxQuery_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  octomap_msgs__srv__BoundingBoxQuery_Response__Sequence * array = (octomap_msgs__srv__BoundingBoxQuery_Response__Sequence *)allocator.allocate(sizeof(octomap_msgs__srv__BoundingBoxQuery_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
octomap_msgs__srv__BoundingBoxQuery_Response__Sequence__are_equal(const octomap_msgs__srv__BoundingBoxQuery_Response__Sequence * lhs, const octomap_msgs__srv__BoundingBoxQuery_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!octomap_msgs__srv__BoundingBoxQuery_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  octomap_msgs__srv__BoundingBoxQuery_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(octomap_msgs__srv__BoundingBoxQuery_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    octomap_msgs__srv__BoundingBoxQuery_Response * data =
      (octomap_msgs__srv__BoundingBoxQuery_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!octomap_msgs__srv__BoundingBoxQuery_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          octomap_msgs__srv__BoundingBoxQuery_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!octomap_msgs__srv__BoundingBoxQuery_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
