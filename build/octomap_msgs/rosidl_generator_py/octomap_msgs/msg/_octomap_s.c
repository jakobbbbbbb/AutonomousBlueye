...
bool octomap_msgs__msg__octomap__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("octomap_msgs.msg._octomap.Octomap", full_classname_dest, 33) == 0);
  }
  octomap_msgs__msg__Octomap * ros_message = _ros_message;
  {  // header
  ...
  {  // binary
    PyObject * field = PyObject_GetAttrString(_pymsg, "binary");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->binary = (Py_True == field);
    Py_DECREF(field);
  }
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Octomap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("octomap_msgs.msg._octomap");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Octomap");
  ...
  octomap_msgs__msg__Octomap * ros_message = (octomap_msgs__msg__Octomap *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // binary
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->binary ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "binary", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
